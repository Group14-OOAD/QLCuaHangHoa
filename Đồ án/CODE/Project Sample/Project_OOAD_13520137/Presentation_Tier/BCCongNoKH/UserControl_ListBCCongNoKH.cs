...
namespace Presentation_Tier
{
    public partial class UserControl_ListBCCongNoKH : UserControl
    {
        ...
        private void btn_TimKiem_Click(object sender, EventArgs e)
        {
            ...
            //try
            //{
            //    _findNgay = dateEdit_Ngay.SelectedText;
            //}
            //catch(Exception ex)
            //{
            //    XtraMessageBox.Show("Lỗi các dữ liệu ngày lọc: \n" + ex.Message);
            //}
            //DataTable searchResult = new DataTable();
            //searchResult = objBCBus.searchNhanVien(_findMaNV, _findHoTen, _findNamSinh, _findMaLoaiNV); ;
            ...
            //gridControl_DSBCCongNoKH.DataSource = _tempTableNV; //Đổ dữ liệu vào gridview
